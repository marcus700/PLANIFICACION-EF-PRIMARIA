...
| Sesiones de C1 | Competencia / Capacidad | Desempeño precisado completo (con **negrita** la parte movilizada) (de {grado_1_cneb}) | Criterios de Evaluación | Evidencia | Instrumento |

**COMPETENCIA 2: Asume una vida saludable**
> **ESTÁNDAR CNEB COMPLETO ({ciclo_actual}):** [Transcribe aquí el estándar COMPLETO de la Competencia 2]
| Sesiones de C2 | Competencia / Capacidad | Desempeño precisado completo (con **negrita**la parte movilizada) (de {grado_1_cneb}) | Criterios de Evaluación | Evidencia | Instrumento |

**COMPETENCIA 3: Interactúa a través de sus habilidades sociomotrices**
> **ESTÁNDAR CNEB COMPLETO ({ciclo_actual}):** [Transcribe aquí el estándar COMPLETO de la Competencia 3]
| Sesiones de C3 | Competencia / Capacidad | Desempeño precisado completo (con **negrita** la parte movilizada) (de {grado_1_cneb}) | Criterios de Evaluación | Evidencia | Instrumento |
...
**COMPETENCIA 1: Se desenvuelve de manera autónoma a través de su motricidad**
> **ESTÁNDAR CNEB COMPLETO ({ciclo_actual}):** [Transcribe aquí el estándar COMPLETO de la Competencia 1]
| Sesiones de C1 | Competencia / Capacidad | Desempeño precisado completo (con **negrita** la parte movilizda) (de {grado_2_cneb}) | Criterios de Evaluación | Evidencia | Instrumento |

**COMPETENCIA 2: Asume una vida saludable**
> **ESTÁNDAR CNEB COMPLETO ({ciclo_actual}):** [Transcribe aquí el estándar COMPLETO de la Competencia 2]
| Sesiones de C2 | Competencia / Capacidad | Desempeño precisado completo (con **negrita** la parte movilizada) (de {grado_2_cneb}) | Criterios de Evaluación | Evidencia | Instrumento |

**COMPETENCIA 3: Interactúa a través de sus habilidades sociomotrices**
> **ESTÁNDAR CNEB COMPLETO ({ciclo_actual}):** [Transcribe aquí el estándar COMPLETO de la Competencia 3]
| Sesiones de C3 | Competencia / Capacidad | Desempeño precisado completo (con **negrita** la parte movilizada) (de {grado_2_cneb}) | Criterios de Evaluación | Evidencia | Instrumento |
---
