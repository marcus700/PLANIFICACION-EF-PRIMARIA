...
with tab2:
    ...
    with st.form("form_sesion"):
        ...
        with col2:
            ...
            fecha_s = st.text_input("Fecha:", value=" ", key="s_fec")
            ...
            with st.spinner("Extrayendo matriz oficial de cneb_datos.py y diseñando la sesión..."):
                try:
                    ...
                    instrucciones = (
                        ...
                        "- **Acuerdos de convivencia:** Establezco junto a mis estudiantes 2 a 3 acuerdos clave para el trabajo en el patio.\n\n"
                        "### B) DESARROLLO (Aprox. 60% del tiempo - 54 min) - Gestión y acompañamiento:\n"
                        "- **Activación Corporal (Calentamiento dinámico):** Realizo un juego motivador dinámico relacionado con " + str(detalles_s) + ", ejercicios de movilidad articular general y TOMA DE PULSO INICIAL.\n"
                        "- Diseño y guío una secuencia metodológica progresiva de lo simple a lo complejo adecuada para " + str(grado_s) + ".\n"
                        "- Explico y ejecuto de 3 a 4 ACTIVIDADES O JUEGOS PRÁCTICOS explicados en detalle para ejecutar en el patio (circuitos motores, juegos tradicionales, dinámicas cooperativas o pre-deportes).\n"
                        "- **Actividad de aplicación:** Ejecuto un juego final, reto grupal o creación colectiva donde mis estudiantes aplican de forma autónoma lo aprendido en la clase.\n"
                        "- Guío una PAUSA DE HIDRATACIÓN y establezco REGLAS DE SEGURIDAD para evitar accidentes en la losa o campo.\n"
                        "- Promuevo la autonomía, el pensamiento estratégico y la interacción saludable en grupos o parejas.\n"
                        "- Aplico una estrategia de retroalimentación (feedback) individual y grupal durante la práctica motriz.\n\n"
                        "### C) CIERRE (Aprox. 20% del tiempo - 18 min):\n"
                        "- **Actividad de Vuelta a la Calma:** Dirijo juegos de baja intensidad, ejercicios de respiración guiada, flexibilidad y estiramientos suaves, y TOMA DE PULSO FINAL.\n"
