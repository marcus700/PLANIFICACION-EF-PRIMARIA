...
# ==============================================================================
# PROMPTS ESPECIALIZADOS QUE LEEN DESDE cneb_datos.py
# ==============================================================================
...
Tu tarea es elaborar una UNIDAD DE APRENDIZAJE completa, extensa, rigurosa, pedagógicamente detallada y alineada al Currículo Nacional (CNEB), siguiendo estrictamente las 10 secciones obligatorias sin cortar el documento al final.

🚨 REGLAS CRÍTICAS DE COMPLETITUD Y DESARROLLO PEDAGÓGICO (OBLIGATORIO LLEGAR HASTA LA SECCIÓN X):
...
2. REDACTA DE FORMA DETALLADA Y COMPLETA cada sección. En la Sección III (Situación Significativa) incluye diagnósticos, retos y propuesta. En la Sección VIII (Matriz de Planificación), desarrolla cada una de las {total_sesiones_unidad} sesiones con criterios claros y evidencias bien formuladas.
...
- Contextualizar en detalle la realidad motriz y de salud de los estudiantes relacionada con la problemática: {problema_contexto}.
...
1. DEBES DESARROLLAR EL PROYECTO COMPLETO LLEGANDO OBLIGATORIAMENTE HASTA LA SECCIÓN IX (RECURSOS, MATERIALES Y FIRMAS). QUEDA STRICTAMENTE PROHIBIDO CORTAR EL DOCUMENTO.
2. REDACTA DE FORMA AMPLIA Y COMPLETA cada sección. En la Sección V (Asamblea), redacta intervenciones realistas y ricas de los alumnos. En la Sección VI (Matriz), coloca criterios de evaluación completos y evidencias claras.
