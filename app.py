...
# ==============================================================================
# OCULTAR ÚNICAMENTE MENÚ Y PIE DE PÁGINA (ESTILO SEGURO)
# ==============================================================================
st.markdown("""
    <style>
            ...
            with st.spinner("Extrayendo matriz oficial de cneb_datos.py y diseñando la sesión..."):
                try:
                    ...
                    instrucciones = (
                        ...
                        "- **Motivación inicial:** Una historia corta, imagen o desafío motriz relacionado con " + str(detalles_s) + ".\n"
                        "- **Recojo de saberes previos:** Preguntas abiertas para rescatar los conocimientos previos de los niños sobre la actividad.\n"
                        "- **Problematización / Conflicto cognitivo:** Un reto motriz o pregunta problematizadora que despierte la curiosidad.\n"
                        "- **Propósito y organización:** Comunicar de forma clara y directa qué van a aprender hoy en " + str(grado_s) + " y cómo se organizarán.\n"
                        "- **Acuerdos de convivencia:** Establecer de 2 a 3 normas o acuerdos clave para el trabajo seguro en el campo o patio.\n"
                        "- **Activación Corporal (Calentamiento dinámico):** Juego motivador dinámico relacionado con " + str(detalles_s) + ", ejercicios de movilidad articular y TOMA DE PULSO INICIAL.\n\n"
                        "### B) DESARROLLO (Aprox. 60% del tiempo - 54 min) - Gestión y acompañamiento:\n"
                        "- Diseña una secuencia metodológica progresiva de lo simple a lo complejo adecuada para " + str(grado_s) + ".\n"
                        "- Incluye de 3 a 4 ACTIVIDADES O JUEGOS PRÁCTICOS explicados en detalle para ejecutar en el patio (circuitos motores, juegos tradicionales, dinámicas cooperativas o pre-deportes).\n"
                        "- Incluye variaciones pedagógicas o variantes de dificultad para adaptar el nivel del juego.\n"
                        "- Incluye una PAUSA DE HIDRATACIÓN guiada y REGLAS DE SEGURIDAD para evitar accidentes en la losa o patio.\n"
                        "- Asegúrate de promover la autonomía, el pensamiento estratégico y la interacción saludable en grupos o parejas.\n"
                        "- Describe de forma transparente la estrategia de retroalimentación (feedback) que brindo como docente durante el desarrollo de la práctica.\n\n"
                        "### C) CIERRE (Aprox. 20% del tiempo - 18 min):\n"
                        "- **Actividad de Vuelta a la Calma:** Juegos de baja intensidad, ejercicios de respiración guiada, flexibilidad y estiramientos suaves, y TOMA DE PULSO FINAL.\n"
                        "- **Metacognición:** Preguntas reflexivas guiadas (¿Qué aprendimos hoy? ¿Cómo lo logramos? ¿Qué dificultades tuvimos? ¿Para qué nos sirve lo aprendido en nuestra vida cotidiana?).\n"
                        "- **Cuidado e Higiene Personal:** Hábitos de aseo personal, lavado correcto de manos y cara, hidratación final y ordenamiento colectivo de los materiales utilizados.\n\n"
