# ==============================================================================
# PROMPTS ESPECIALIZADOS Y COMPLETOS PARA EDUCACIÓN FÍSICA (cneb_datos.py)
# ==============================================================================
...
1. DEBES FINALIZAR EL DOCUMENTO OBLIGATORIAMENTE HASTA LA SECCIÓN X (RECURSOS Y ESPACIO PARA FIRMAS DE DIRECTORA Y DOCENTE). QUEDA PROHIBIDO CORTAR EL DOCUMENTO.
2. EN LA SECCIÓN VIII (MATRIZ DE PLANIFICACIÓN), DESARROLLA CADA UNA DE LAS {total_sesiones} SESIONES ({duracion_semanas} semanas, {sesiones_por_semana} sesión(es) por semana) DE FORMA TÉCNICA Y COMPLETA. ESTÁ PROHIBIDO PONER PUNTOS SUSPENSIVOS (...) O OMITIR SESIONES.
