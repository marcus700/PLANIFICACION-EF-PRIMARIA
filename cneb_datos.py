...
def obtener_ciclo_primaria(grado: str) -> str:
    ...
    if "1°" in grado or "2°" in grado or "1er" in grado or "2do" in grado:
        return "III Ciclo"
    elif "3°" in grado or "4°" in grado or "3er" in grado or "4to" in grado:
        return "IV Ciclo"
    elif "5°" in grado or "6°" in grado or "5to" in grado or "6to" in grado:
        return "V Ciclo"
    return "III Ciclo"
